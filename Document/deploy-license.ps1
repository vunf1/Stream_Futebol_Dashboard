...
param(
    [Parameter()][ValidateNotNullOrEmpty()][string]$BuildScript = ".\build-License.py",
    [Parameter()][ValidateNotNullOrEmpty()][string]$DistFolder  = ".\dist",
    [Parameter()][ValidateNotNullOrEmpty()][string]$ExeName     = "license_generator.exe",
    [Parameter()][ValidateNotNullOrEmpty()][string]$TargetRoot  = "$Env:USERPROFILE\Desktop\License Generator\",
    [Parameter()][ValidateNotNullOrEmpty()][string]$TargetExe   = "license_generator.exe"
)
